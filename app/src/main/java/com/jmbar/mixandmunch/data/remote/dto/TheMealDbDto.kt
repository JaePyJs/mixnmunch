package com.jmbar.mixandmunch.data.remote.dto
...
data class MealFilterResponse(
    @SerialName("meals") val meals: List<MealFilterDto>?
)
...
data class MealDetailDto(
    ...
    /**
     * Extract ingredients and measurements, filtering out empty values
     */
    fun getIngredients(): List<Pair<String, String>> {
        ...
        ).map { it.takeIf { measure -> measure.isNotBlank() } ?: "" }
